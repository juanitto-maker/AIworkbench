...
_aiwb() {
    ...
    case "${prev}" in
        ...
        --model)
            ...
            COMPREPLY=( $(compgen -W "2.5-flash 2.5-flash-lite 2.5-pro 2.0-flash 2.0-pro 1.5-flash 3-5-sonnet-20241022 3-haiku-20240307 3-opus-20240229 sonnet-4-5-20250929 gpt-5 gpt-4o gpt-4o-mini o3 o4-mini grok-4 grok-3 llama-4-scout llama-4-maverick" -- ${cur}) )
            return 0
            ;;
